const MainNavbar = () => {
  return (
    <nav
      className="bg-grey rounded border-gray-200 px-2 py-2.5 dark:bg-gray-900 sm:px-4"
      style={{ backgroundColor: "#f2f0ee" }}
    >
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        <a href="https://www.fuxam.de/" className="flex items-center">
          <img
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul
            className="mt-4 flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:bg-white md:text-sm md:font-medium md:dark:bg-gray-900"
            style={{ backgroundColor: "#f2f0ee" }}
          >
            <li>
              <a
